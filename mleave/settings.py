# Django settings for mleave project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mleave',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '!s=v@*cyn2$)d+=k%2n141c6_ne+!v45!(bx7#gm9lcis^$t=^'
...
WSGI_APPLICATION = 'mleave.wsgi.application'
